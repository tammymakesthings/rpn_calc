...
class TestMathHelpers:
    ...
    def test_ncr_throws_exception_on_negative_operands(self, input_population, input_sets):
        with pytest.raises(ValueError):
            _ = mh.ncr(6, 49)
    ...
    def test_npr_throws_exception_on_negative_operands(self, input_population, input_sets):
        with pytest.raises(ValueError):
